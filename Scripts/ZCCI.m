ZCCI ; Import the Cache Object XML files into the instance
 ;---------------------------------------------------------------------------
...
LIST(IO,DIR) ; Read list from IO, load Globals from each DIR<entry> device
 ...
 F  Q:'$$READLINE(.XML)  U $P W $SYSTEM.OBJ.Load(DIR_XML),!,! I '$T S Q=0
 G QUIT
 ;---------------------------------------------------------------------------
...
ASKIO
 ...
 I IO="^" S IO=""
 Q
 W "Output directory must end in a slash!" Q 0